...
display telemetries that exist for the item but have no data in the selected timerange. 

{% include images-gallery.html imageCollection="inactive-telemetries" %}

If it still does not appear, perform a **topology discovery** to sync the latest ThingsBoard structure with Trendz.

{% include images-gallery.html imageCollection="topology-discovery" %}
